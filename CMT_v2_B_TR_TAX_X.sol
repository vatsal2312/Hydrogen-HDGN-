...
/**
 * @title CMT_v2_B_TR_TAX_X
 * @author Create My Token (https://www.createmytoken.com/)
 * @dev Implementation of the CMT_v2_B_TR_TAX_X
 */
contract CMT_v2_B_TR_TAX_X is Context, IERC20, ERC20Ownable, Helper, TokenGeneratorMetadata {
    ...
    constructor(
        ...
        // _tOwned[_msgSender()] = __cmt_initial;
